...
& cmd.exe /c 'd:\OracleClient12\setup.exe -silent "ORACLE_HOSTNAME=%computername%.%userdnsdomain%" -nowelcome -nowait -responseFile "d:\tmp\Neat Test server setup\Oracle\client_install.rsp"' | Out-null
